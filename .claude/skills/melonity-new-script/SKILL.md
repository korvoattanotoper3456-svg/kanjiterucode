...
Задача этого скилла — дать Claude полный рабочий контекст для написания **корректного** Melonity-скрипта с первого раза, без переписываний из-за вымышленных API-имён.
